...
## Hinweis zum Paladin-Spannungsfeld

- Divine Sense erkennt nur Fiends/Undead/Celestials — ein menschlicher Sharran-Kleriker wird *nicht* automatisch erkannt. Das gibt dir sauberen Spielraum für echten Zweifel statt Meta-Wissen.
- Nutze Station 9 (Salon-Begegnung) oder eine Traum-/Visions-Szene für einen Bauchgefühl-Rettungswurf (WEI, SG 14, wie in Tänzerin.md vorgeschlagen).
- Eine Szene, in der Paladin und Lysandra unwissentlich gemeinsam an einer Zeremonie beteiligt waren, kann nachträglich für Unbehagen sorgen, ohne dass es eine "falsche Entscheidung" gab.
